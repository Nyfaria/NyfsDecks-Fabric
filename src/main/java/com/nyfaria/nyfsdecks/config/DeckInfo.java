...
import com.nyfaria.nyfsdecks.mixin.SoundEventAccessor;
 ...
 *
 * BackpackInfo instances are automatically read from the config file and used in {@link DeckItem}.
 */
public class DeckInfo {
     ...
     */
    public DeckInfo(String name, int rowWidth, int numberOfRows, boolean isFireImmune, String openSound) {
        this.name = name;
     ...
     * @param numberOfRows  number of horizontal slot groups
     */
    public static DeckInfo of(String name, int rowWidth, int numberOfRows, boolean isFireImmune, SoundEvent openSound) {
        return new DeckInfo(name, rowWidth, numberOfRows, isFireImmune, ((SoundEventAccessor) openSound).getId().toString());
    }
}
