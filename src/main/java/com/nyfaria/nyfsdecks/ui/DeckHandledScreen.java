...
import com.nyfaria.nyfsdecks.api.Rectangle;
...
public class DeckHandledScreen extends HandledScreen<DeckScreenHandler> {

    private static final Identifier GUI_TEXTURE = new Identifier("nyfsdecks", "textures/gui/backpack_container.png");
    ...
    public DeckHandledScreen(DeckScreenHandler handler, PlayerInventory player, Text title) {
        super(handler, player, title);
        
        Dimension dimension = handler.getDimension(new DeckInfo("Basic",13,4,false, null));
